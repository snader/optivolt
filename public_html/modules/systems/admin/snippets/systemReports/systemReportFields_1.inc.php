...
<div class="row">
  <div class="col-md-12 form-group">
    <input type="text" name="wideInfo" placeholder="cos phi = ###" <?= !$oSystemReport->isEditable() ? 'readonly disabled ' : '' ?> class="form-control" id="wideInfo" value="<?= _e($oSystemReport->wideInfo) ?>" title="3 column wide info" data-msg="<?= sysTranslations::get('global_field_not_completeds') ?>">
  </div>
</div>
<div id="addRowsHere">
  <div class="row">
    <div class="col-sm-3 form-group">
      <input type="text" name="columnA" <?= !$oSystemReport->isEditable() ? 'readonly disabled ' : '' ?> class="form-control" id="columnA" value="<?= empty($oSystemReport->columnA) ? 'K1' : _e($oSystemReport->columnA) ?>" title="K#" required data-msg="<?= sysTranslations::get('global_field_not_completeds') ?>">
  ...
  ?>
      <div class="row">
        ...
        <div class="col-sm-3 form-group">
          <input type="text" name="columnAextra[]" <?= !$oSubSystemReport->isEditable() ? 'readonly disabled ' : '' ?> class="form-control" id="columnAextra[]" value="<?= _e($oSubSystemReport->columnA) ?>" title="K#" required data-msg="<?= sysTranslations::get('global_field_not_completeds') ?>">
...
<div style="display:none;" id="rowToBeAdded">
  <div class="row">
    ...
    <div class="col-sm-3 form-group">
      <input type="text" name="columnAextra[]" class="form-control" id="columnAextra[]" value="replace" title="K#" data-msg="<?= sysTranslations::get('global_field_not_completeds') ?>">
