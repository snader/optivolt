...
if (!$oDb->tableExists('evaluations')) {
    ...
    if ($bInstall) {
        ...
        CREATE TABLE `evaluations` (
          ...
          `installSat` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
          `anyDetails` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
          `conMeasured` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
          `prepSat` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
          `workSat` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
          `answers` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
          `friendlyHelpfull` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
