    ...
    public static function saveEvaluation(Evaluation $oEvaluation)
    {
        $sQuery = ' INSERT INTO `evaluations` (
                    ...
                    VALUES (
                        ...
                        ' . db_str($oEvaluation->installSat) . ',                        
                        ' . db_str($oEvaluation->anyDetails) . ',
                        ' . db_str($oEvaluation->conMeasured) . ',
                        ' . db_str($oEvaluation->prepSat) . ',
                        ' . db_str($oEvaluation->workSat) . ',
                        ' . db_str($oEvaluation->answers) . ',
                        ' . db_str($oEvaluation->friendlyHelpfull) . ',
