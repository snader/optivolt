            ...
            <div class="columns is-mobile">
                ...
                <div class="column">
                    <a href="#" class="cta">
                        ...
                        <span><?= _e(SiteTranslations::get('site_chat_with_us')) ?></span>
                    </a>
                </div>
                <div class="column">
                    <a href="#" class="cta">
                        <i class="far fa-whatsapp"></i>
                        <span><?= _e(SiteTranslations::get('site_send_whatsapp')) ?></span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="columns is-desktop">
                ...
                <div class="column">
                    <div class="footer-col">
                        <div class="title">
                            <?= _e(SiteTranslations::get('site_openings_hours')) ?>
                        </div>
                        <div class="openings-hours">
                            <div class="columns">
                                <div class="column"><?= _e(SiteTranslations::get('site_mo_fr')) ?></div>
                                <div class="column">07:00 - 19:00</div>
                            </div>
                            <div class="columns">
                                <div class="column"><?= _e(SiteTranslations::get('site_sat')) ?></div>
                                <div class="column">07:00 - 19:00</div>
                            </div>
                            <div class="columns">
                                <div class="column"><?= _e(SiteTranslations::get('site_sun')) ?></div>
                                <div class="column">07:00 - 19:00</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column">
                    <div class="footer-col">
                        <div class="title is-hidden-mobile">
                            <?= _e(SiteTranslations::get('site_follow_us')) ?>
                        </div>
            ...
            <div class="footer-copyright">
                <div class="columns">
                    <div class="column">
                        <div class="copyright">
                            Copyright <?= date('Y') ?> - <?= _e(CLIENT_NAME) ?>
                        </div>
                    </div>
                    <?php
